<template>
  <v-app dark>
    <v-toolbar app fixed clipped-left>
      <v-toolbar-side-icon v-if="navigationDrawer" @click.stop="drawer = !drawer"></v-toolbar-side-icon>
      <v-toolbar-title>
    ...
    <v-navigation-drawer v-if="navigationDrawer" v-model="drawer" app fixed clipped>
      <slot name="navigationDrawerList"></slot>
    </v-navigation-drawer>
    <v-content>
    ...
    <v-footer class="pa-3" app dark>
      <v-btn href="https://github.com/jabez007/cryptotron/issues" icon small target="_blank">
