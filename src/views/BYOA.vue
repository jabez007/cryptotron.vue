...
// @ is an alias to /src
import * as Affine from '../lib/ciphers/affine';
import * as Autokey from '../lib/ciphers/autokey';
import * as Baconian from '../lib/ciphers/baconian';
import * as Beaufort from '../lib/ciphers/beaufort';
import * as Caesar from '../lib/ciphers/caesar';
import * as ColumnarTransposition from '../lib/ciphers/columnarTransposition';
import * as FourSquare from '../lib/ciphers/fourSquare';
import * as Huffmanian from '../lib/ciphers/huffmanian';
import * as Polybius from '../lib/ciphers/polybius';
import * as RailFence from '../lib/ciphers/railFence';
import * as RunningKey from '../lib/ciphers/runningKey';
import * as Substitution from '../lib/ciphers/substitution';
