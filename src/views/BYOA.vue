...
// @ is an alias to /src
import * as Affine from '_/ciphers/affine';
import * as Autokey from '_/ciphers/autokey';
import * as Baconian from '_/ciphers/baconian';
import * as Beaufort from '_/ciphers/beaufort';
import * as Caesar from '_/ciphers/caesar';
import * as ColumnarTransposition from '_/ciphers/columnarTransposition';
import * as FourSquare from '_/ciphers/fourSquare';
import * as Huffmanian from '_/ciphers/huffmanian';
import * as Polybius from '_/ciphers/polybius';
import * as RailFence from '_/ciphers/railFence';
import * as RunningKey from '_/ciphers/runningKey';
import * as Substitution from '_/ciphers/substitution';
import * as Vigenere from '_/ciphers/vigenere';
...
export default {
  ...
  computed: {
    ...
    algorithmLink() {
      return `${window.location.protocol}//${window.location.hostname}${window.location.port ? `:${window.location.port}` : ''}/#/builder/${btoa(this.jsonString)}`;
    },
  },
  watch: {
    saveSelectValue() {
