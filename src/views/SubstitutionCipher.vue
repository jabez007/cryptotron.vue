  ...
  >
    <vs-card class="card cipher" slot="description">
      <div class="header" slot="header">
        <h5>The Simple Substitution Cipher</h5>
      </div>
      <div class="main">
        <p>
          ...
          plaintext character for a different ciphertext character. It differs
          from the
          <a @click="$router.push({ name: 'cryptotron-caesar' })"
            >Caesar cipher</a
          >
          in that the cipher alphabet is not simply the alphabet shifted, it is
          completely jumbled.
        </p>
        <p>
          Still though, the simple substitution cipher offers very little
          communication security, and it will be shown that it can be easily
          broken even by hand, especially as the messages become longer (more
          than several hundred ciphertext characters).
        </p>
        <p>
          Keys for the simple substitution cipher consist of 26 letters
          (compared to the caeser cipher's single number). So encyption is just
          each character in the plaintext replaced with the corresponding letter
          in the key or cipher alphabet. Decryption is just as easy, by going
          from the cipher alphabet back to the plain alphabet.
        </p>
        <p>
          When generating keys it is popular to use a key word, e.g.
          <a class="example" @click="key.keyword = 'uncopyrightable'"
            >'uncopyrightable'</a
          >, or a phrase, e.g.
          <a
            class="example"
          ...
          >, to generate it, since it is much easier to remember a key word or
          phrase compared to a random jumble of 26 characters. Or, another
          popular key for the Simple Substitution cipher is known as the
          <a class="example" @click="key.keyword = 'qwertyuiopasdfghjklzxcvbnm'"
            >'QWERTY'</a
          >
